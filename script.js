...
const musicaLabel = document.querySelector('.app__card-list-label');
...
musicaFocoInput.addEventListener('change', () => {
    if (musica.paused) {
        musica.play();
        musicaLabel.innerHTML = 'Desligar Musica';
    } else {
        musica.pause();
        musicaLabel.innerHTML = 'Ligar Musica'
    }
});
...
function alterarContexto(contexto) { 
    ...
    switch (contexto) {
        ...
        case "descanso-curto":
            titulo.innerHTML = `
            Que tal das uma respirada?<br><strong class="app__title-strong">Faça uma pausa curta!</strong>
            `
            break;
        case "descanso-longo":
            titulo.innerHTML = `
